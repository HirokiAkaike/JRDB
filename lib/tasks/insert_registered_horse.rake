module InsertRegisteredHorseTask
  namespace :insert_registered_horse do
    require_relative '../../app/helpers/disassemble_refund_bet_ticket.rb'
      ...
      targetFilesPath.each do |filePath|
        ...
        File.open(filePath) do |file|
          ...
          file.each_line do |line|
            ...
            registeredHorses << refundBetTicket
          end
        end
        RefundBetTicket.import registeredHorses
      end
    end
  end
end